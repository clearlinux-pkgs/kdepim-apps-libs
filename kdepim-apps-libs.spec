...
Version  : 19.12.3
Release  : 24
URL      : https://download.kde.org/stable/release-service/19.12.3/src/kdepim-apps-libs-19.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/19.12.3/src/kdepim-apps-libs-19.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.3/src/kdepim-apps-libs-19.12.3.tar.xz.sig
...
%prep
%setup -q -n kdepim-apps-libs-19.12.3
cd %{_builddir}/kdepim-apps-libs-19.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583533301
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdepim-apps-libs-19.12.3/COPYING %{buildroot}/usr/share/package-licenses/kdepim-apps-libs/6a3bf83ab62e047649bdf91a17c9311737cede0f
cp %{_builddir}/kdepim-apps-libs-19.12.3/COPYING.LIB %{buildroot}/usr/share/package-licenses/kdepim-apps-libs/c914b1f9fc73a1ae187da32447bd161823f8b9e8
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5FollowupReminder.so.5.13.3
/usr/lib64/libKF5KaddressbookGrantlee.so.5
/usr/lib64/libKF5KaddressbookGrantlee.so.5.13.3
/usr/lib64/libKF5KaddressbookImportExport.so.5
/usr/lib64/libKF5KaddressbookImportExport.so.5.13.3
/usr/lib64/libKF5KdepimDBusInterfaces.so.5
/usr/lib64/libKF5KdepimDBusInterfaces.so.5.13.3
/usr/lib64/libKF5SendLater.so.5
/usr/lib64/libKF5SendLater.so.5.13.3
